...
public class MenuPrincipal extends JPanel implements ActionListener {
	...
	public MenuPrincipal()
	{
	    ...
	    menu[4]= new JLabel(new ImageIcon(chemin + "nouvelle partie2.png"));
		menu[5]= new JLabel(new ImageIcon(chemin + "options2.png"));
		menu[6]= new JLabel(new ImageIcon(chemin + "meilleur score2.png"));
		menu[7]= new JLabel(new ImageIcon(chemin + "quitter2.png"));
		...
		menu[4].setSize(new Dimension(menu[0].getIcon().getIconWidth(), menu[0].getIcon().getIconHeight()));
		this.add(menu[4]);
		menu[4].setLocation(new Point(40,500));
		menu[5].setSize(new Dimension(menu[1].getIcon().getIconWidth(), menu[1].getIcon().getIconHeight()));
		this.add(menu[5]);
		menu[5].setLocation(new Point(660-menu[1].getWidth(),500));
		menu[6].setSize(new Dimension(menu[2].getIcon().getIconWidth(), menu[2].getIcon().getIconHeight()));
		this.add(menu[6]);
		menu[6].setLocation(new Point(40,600));
		menu[7].setSize(new Dimension(menu[3].getIcon().getIconWidth(), menu[3].getIcon().getIconHeight()));
		this.add(menu[7]);
		menu[7].setLocation(660-menu[3].getWidth(),600);
